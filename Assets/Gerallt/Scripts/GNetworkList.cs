...
namespace Gerallt
{
    ...
    public class GNetworkList<T> : NetworkVariableBase where T : unmanaged, IEquatable<T>
    {
        ...
        public GNetworkList(NetworkVariableReadPermission readPerm, IEnumerable<T> values) : base(readPerm)
        {
        ...
        /// </summary>
        /// <param name="values">The initial value to use for the NetworkList</param>
        public GNetworkList(IEnumerable<T> values)
        {
            foreach (var value in values)
            {
                m_List.Add(value);
        ...
        public override void WriteDelta(FastBufferWriter writer)
        {
            ...
            //writer.WriteValueSafe((int)NetworkTickSystem.NoTick);
        ...
        {
            //reader.ReadValueSafe(out int tickSystem);
